...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //Implementa a ação de abrir um link no navegador do dispositivo
...
//       //Implementa a ação de compartilhar
        ...
        //Implementa a ação de favoritar (o evento será instanciado pelo Fragment)
